...
def plot_correlation(lat, lon, var, titulo, output):
    ...
    barra = plt.cm.get_cmap('PRGn',11) #colorbar
...
def main():
    ...
    for i in modelos:
        ...
        route = '/home/osman/proyectos/postdoc/'
        archivo = args.variable[0] + '_' + i['nombre']+ '_' + IC + '_' + SSS +\
                '_gp_01_p_rmean.png'
        plot_correlation(lat, lon, rmean[:,:,ii], 'Correlation - ' + i['nombre'], route + archivo)
        ii = ii + 1
